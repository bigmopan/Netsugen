...
class CurriculumsControllerTest < ActionController::TestCase
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post :create, curriculum: { body: @curriculum.body, check: @curriculum.check, image: @curriculum.image, title: @curriculum.title, user_id: @curriculum.user_id }
    end
  ...
  test "should update curriculum" do
    patch :update, id: @curriculum, curriculum: { body: @curriculum.body, check: @curriculum.check, image: @curriculum.image, title: @curriculum.title, user_id: @curriculum.user_id }
    assert_redirected_to curriculum_path(assigns(:curriculum))
  end
